...
#define SETTING_MONITOR_24K		1
										// 24KHz analog monitor
#define SETTING_MONITOR_15K		0
...
#define DEFAULT_STATUS_LINE		(false)
										// status line
#define DEFAULT_STATUS_ALPHA		0x00
										// alpha blending level for status
#define DEFAULT_SCALE_QUALITY		0
